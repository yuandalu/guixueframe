...
class QFrameHttp
{
    ...
    {
        if (null === $key) {
            $res = array_merge($this->getPost(null, null), $this->getQuery(null, null), $this->getData(null, null));

            return $res;
        }
        if (null !== ($res = $this->getData($key, null))) {
            return $res;
        }
